...
torchrun --master_port 29510  --nproc_per_node 4 train.py --model phasenet  --backbone xunet \
    ...
    --hdf5-file /global/scratch/users/haoyuwang/quakeflow_dataset/NC/quakeflow_nc/waveform_train.h5 \
    --test-hdf5-file /global/scratch/users/haoyuwang/quakeflow_dataset/NC/quakeflow_nc/waveform_train.h5 \
    --output-dir phasenet_xunet \
    --stack-event --stack-noise --flip-polarity --drop-channel \
    --wandb --wandb-group ai4eps  --wandb-dir /pscratch/sd/w/whaoyu/tests_eqnet/ --wandb-project phasenet --wandb-name phasenet_xunet
...
torchrun --master_port 29511  --nproc_per_node 4 train.py --model phasenet  --backbone unet \
    ...
    --stack-event --stack-noise --flip-polarity --drop-channel \
    --wandb --wandb-group ai4eps  --wandb-dir /pscratch/sd/w/whaoyu/tests_eqnet/ --wandb-project phasenet --wandb-name phasenet_unet
...
torchrun --master_port 29512  --nproc_per_node 4 train.py --model phasenet_tf  --backbone xunet \
    ...
    --stack-event --stack-noise --flip-polarity --drop-channel \
    --wandb --wandb-group ai4eps  --wandb-dir /pscratch/sd/w/whaoyu/tests_eqnet/ --wandb-project phasenet --wandb-name phasenet_tf_xunet
...
torchrun --master_port 29513  --nproc_per_node 4 train.py --model phasenet_tf  --backbone unet \
    ...
    --stack-event --stack-noise --flip-polarity --drop-channel \
    --wandb --wandb-group ai4eps  --wandb-dir /pscratch/sd/w/whaoyu/tests_eqnet/ --wandb-project phasenet --wandb-name phasenet_tf_unet
...
torchrun --master_port 29514  --nproc_per_node 4 train.py --model phasenet_plus  --backbone xunet \
    ...
    --stack-event --stack-noise --flip-polarity --drop-channel \
    --wandb --wandb-group ai4eps  --wandb-dir /pscratch/sd/w/whaoyu/tests_eqnet/ --wandb-project phasenet --wandb-name phasenet_plus_xunet
...
torchrun --master_port 29515  --nproc_per_node 4 train.py --model phasenet_plus  --backbone unet \
    ...
    --stack-event --stack-noise --flip-polarity --drop-channel \
    --wandb --wandb-group ai4eps  --wandb-dir /pscratch/sd/w/whaoyu/tests_eqnet/ --wandb-project phasenet --wandb-name phasenet_plus_unet
...
torchrun --master_port 29517  --nproc_per_node 4 train.py --model phasenet_tf_plus  --backbone xunet \
    ...
    --stack-event --stack-noise --flip-polarity --drop-channel \
    --wandb --wandb-group ai4eps  --wandb-dir /pscratch/sd/w/whaoyu/tests_eqnet/ --wandb-project phasenet --wandb-name phasenet_tf_plus_xunet
...
torchrun --master_port 29516  --nproc_per_node 4 train.py --model phasenet_tf_plus  --backbone unet \
    ...
    --stack-event --stack-noise --flip-polarity --drop-channel \
    --wandb --wandb-group ai4eps  --wandb-dir /pscratch/sd/w/whaoyu/tests_eqnet/ --wandb-project phasenet --wandb-name phasenet_tf_plus_unet 
...
torchrun --master_port 29518  --nproc_per_node 4 train.py --model phasenet_prompt  --backbone xunet \
    ...
    --stack-event --stack-noise --flip-polarity --drop-channel \
    --wandb --wandb-group ai4eps  --wandb-dir /pscratch/sd/w/whaoyu/tests_eqnet/ --wandb-project phasenet --wandb-name phasenet_prompt_xunet
...
torchrun --master_port 29519  --nproc_per_node 4 train.py --model phasenet_prompt  --backbone unet \
    ...
    --stack-event --stack-noise --flip-polarity --drop-channel \
    --wandb --wandb-group ai4eps  --wandb-dir /pscratch/sd/w/whaoyu/tests_eqnet/ --wandb-project phasenet --wandb-name phasenet_prompt_unet
