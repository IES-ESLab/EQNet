...
torchrun --master_port 29516  --nproc_per_node 4 train.py --model phasenet_tf_plus  --backbone xunet --hdf5-file /global/home/users/zhuwq0/scratch/CEED/quakeflow_nc/waveform_test.h5 --workers 16 --batch-size 128 --output-dir phasenet_plus_xunet --lr 0.0003 --wandb --wandb-project phasenet --wandb-name phasenet_tf_plus_xunet
torchrun --master_port 29517  --nproc_per_node 4 train.py --model phasenet_tf_plus  --backbone unet --hdf5-file /global/home/users/zhuwq0/scratch/CEED/quakeflow_nc/waveform_test.h5 --workers 16 --batch-size 128 --output-dir phasenet_plus_unet --lr 0.001 --wandb --wandb-project phasenet --wandb-name phasenet_tf_plus_unet

torchrun --master_port 29518  --nproc_per_node 4 train.py --model phasenet_prompt  --backbone xunet --hdf5-file /global/home/users/zhuwq0/scratch/CEED/quakeflow_nc/waveform_test.h5 --workers 16 --batch-size 16 --output-dir phasenet_prompt_xunet --lr 0.0003 --wandb --wandb-project phasenet --wandb-name phasenet_prompt_xunet
torchrun --master_port 29519  --nproc_per_node 4 train.py --model phasenet_prompt  --backbone unet --hdf5-file /global/home/users/zhuwq0/scratch/CEED/quakeflow_nc/waveform_test.h5 --workers 16 --batch-size 16 --output-dir phasenet_prompt_unet --lr 0.001 --wandb --wandb-project phasenet --wandb-name phasenet_prompt_unet