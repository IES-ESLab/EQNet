...
base_cmd = f"../train.py --model phasenet_das --sync-bn --batch-size=4 --epochs=10 --wd=1e-1  --stack-event --stack-noise --resample-space --resample-time --masking --random-crop --output=phasenet_das_unet --wandb --wandb-project=phasenet --wandb-name=phasenet_das_unet"
if args.resume:
